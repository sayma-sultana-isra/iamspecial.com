...
The Parent Supporting System for an Autistic Child is a web-based application designed to empower parents, caregivers, and educators with tools and insights to support children with autism effectively. This system combines social interaction, educational resources, behavior tracking, and planning tools in a single, easy-to-use platform.
...
Database: MySQL (with structured tables for users, posts, events, and reports)
...
Use the registration page to create an account and explore features.

Use the registration module to create your first account.
...
GitHub: github.com/saymasultana
